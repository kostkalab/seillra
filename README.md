...
- Chromatin states and sequence classes: [basic_notebook.ipynb](./dist/seillra/doc/basic_usage.ipynb)
- Variant effects: [variant_notebook.ipynb](./dist/seillra/doc/variant_usage.ipynb)
